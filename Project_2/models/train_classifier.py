...
def load_data(database_filepath):
    '''Loading the data from our databse and doing some processing like there are 3 vunique values present in the related col so we are replacing all the 2's with 1's'''
